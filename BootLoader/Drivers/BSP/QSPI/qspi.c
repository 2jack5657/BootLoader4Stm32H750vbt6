...
uint8_t qspi_init(void)
{
    ...
    g_qspi_handle.Init.ClockPrescaler = 1;                             /* QPSI分频比，W25Q128最大频率为133M，
                                                                          所以此处应该为2，QSPI频率就为240/(1+1)=120MHZ
    ...
    g_qspi_handle.Init.ChipSelectHighTime = QSPI_CS_HIGH_TIME_7_CYCLE; /* 片选高电平时间为3个时钟(9.1*3=27.3ns),即手册里面的tSHSL参数 */
